...
responses = {
    'predictions': response1.json()['predictions'],
    'scoring': response2.json()['f1_score'],
    'summarystats': response3.json()['summary_statistics'],
    'diagnostics': response4.json()['diagnostics']
}
